      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            label: 'Personalize',
            position: 'right',
            to: '/api/personalize', // Personalization button per spec
          },
          {
            label: 'Translate Urdu',
            position: 'right',
            to: '/api/translate-ur', // Urdu translation button per spec
          },
          {
            href: 'https://github.com/Q4AIAgents/my-Physical-AI-Humanoid-Robotics-Book',
            label: 'GitHub',
            position: 'right',
          },
        ],
